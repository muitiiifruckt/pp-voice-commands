...
**Промпты:** полный перечень сформулированных запросов и блок «что делалось самостоятельно» — в файле **[prompts/PROMPTS_RU.md](prompts/PROMPTS_RU.md)** (папка `docs/prompts/` в репозитории).
